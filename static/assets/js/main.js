...
var App = function() {
    ...
    function b() {
        ...
        function b() {
            k.removeClass(i.openLeftSidebarClass).addClass(i.transitionClass),
            d()
        }
        function c(a) {
            ...
            function(a, b) {
                ...
                f = $('<li class="nav-items"><div class="am-scroller nano"><div class="content nano-content"><ul></ul></div></div></li>'); ! d.find("> li.title").length > 0 && (d.prepend(c), e.appendTo(f.find(".content ul")), f.appendTo(d))
            })
        }
        $(".am-toggle-left-sidebar").on("click",
        function(c) {
            o && k.hasClass(i.openLeftSidebarClass) ? b() : o || a(),
            c.stopPropagation(),
            c.preventDefault()
        }),
        $(document).on("touchstart mousedown",
        function(a) { ! $(a.target).closest(m).length && k.hasClass(i.openLeftSidebarClass) && b()
        });
        ...
        function() {
            ...
            b = $(this).parent(),
            d = b.find("> ul");
            $.isXs() || ($("ul.visible", m).removeClass("visible"), d.removeClass("hide"), d.addClass("visible")),
            a.nanoScroller({
                destroy: !0
            }),
            a.nanoScroller(),
            i.syncSubMenuOnHover && c(b)
        }), e.on("mouseleave",
        function() {
            ...
            300)
        }), $(".sidebar-elements li a", m).on("click",
        function(a) {
            if ($.isXs()) {
                var b, c = $(this),
            ...
            f.wrap('<div class="am-scroller nano"></div>'),
            f.addClass("nano-content"),
            f.parent().nanoScroller()
        }
    ...
    function c() {
        ...
        n.length > 0 && ($(".am-toggle-right-sidebar").on("click",
        function(c) {
            o && k.hasClass(i.openRightSidebarClass) ? b() : o || a(),
            c.stopPropagation(),
            c.preventDefault()
        }), $(document).on("mousedown touchstart",
        function(a) { ! $(a.target).closest(n).length && k.hasClass(i.openRightSidebarClass) && b()
        }))
    }
    function d() {
        o = !0,
    ...
    function e() {
        l.swipe({
            ...
            swipeLeft: function(a) { ! o && n.length > 0 && (k.addClass(i.openRightSidebarClass + " " + i.transitionClass), o = !0)
            },
    ...
    return {
        ...
        init: function(d) {
            ...
            f(),
            i.enableSwipe && e(),
            m.on("transitionend webkitTransitionEnd oTransitionEnd MSTransitionEnd",
            function() {
...
function() {
    ...
    function u(b, c, d) {
        ...
        f = 360 / d,
        g = [a(b)];
        for (e.h = (e.h - (f * c >> 1) + 720) % 360; --c;) e.h = (e.h + f) % 360,
        g.push(a(e));
        return g
    }
    function v(b, c) {
    ...
    a.mostReadable = function(b, c, d) {
        ...
        g = d.level,
        h = d.size;
        for (var k = 0; k < c.length; k++) e = a.readability(b, c[k]),
        e > j && (j = e, i = a(c[k]));
    ...
    function c(b, c) {
        function d(b) {
            if (! (ja() || a(b.target).closest(c.excludedElements, Ta).length > 0)) {
                ...
                ha(),
                la(0, g),
                !f || Va === c.fingers || c.fingers === t || R() ? (Xa = za(), 2 == Va && (la(1, f[1]), Na = Oa = ta(Wa[0].start, Wa[1].start)), (c.swipeStatus || c.pinchStatus) && (d = J(e, Ua))) : d = !1,
                d === !1 ? (Ua = y, J(e, Ua), d) : (c.hold && (bb = setTimeout(a.proxy(function() {
                    Ta.trigger("hold", [e.target]),
                    c.hold && (d = c.hold.call(Ta, e, e.target))
                },
        ...
        function E(a) {
            ...
            Ya = za(),
            Ma = sa(),
            M() || !L() ? (Ua = y, J(b, Ua)) : c.triggerOnTouchEnd || c.triggerOnTouchEnd === !1 && Ua === w ? (c.preventDefaultEvents !== !1 && a.preventDefault(), Ua = x, J(b, Ua)) : !c.triggerOnTouchEnd && Y() ? (Ua = x, K(b, Ua, o)) : Ua === w && (Ua = y, J(b, Ua)),
            ka(!1),
            null
        }
        function F() {
        ...
        function K(b, d, k) {
            ...
            this), c.doubleTapThreshold)) : (_a = null, Ta.trigger("tap", [b.target]), c.tap && (l = c.tap.call(Ta, b, b.target)))) : k == p ? d !== y && d !== x || (clearTimeout(ab), clearTimeout(bb), _a = null, Ta.trigger("doubletap", [b.target]), c.doubleTap && (l = c.doubleTap.call(Ta, b, b.target))) : k == q && (d !== y && d !== x || (clearTimeout(ab), _a = null, Ta.trigger("longtap", [b.target]), c.longTap && (l = c.longTap.call(Ta, b, b.target)))),
            l
        }
        function L() {
            var a = !0;
        ...
        function P(a, b) {
            if (c.preventDefaultEvents !== !1) if (c.allowPageScroll === k) a.preventDefault();
            else {
...
App = function() {
    ...
    return App.chartsSparklines = function() {
        ...
        $.fn.sparkline.defaults.common.fillColor = a.setAlpha(.3).toString(),
        ...
        $.fn.sparkline.defaults.bar.negBarColor = f,
        $.fn.sparkline.defaults.bar.stackedBarColor[0] = e,
        $.fn.sparkline.defaults.bar.stackedBarColor[1] = f,
        $.fn.sparkline.defaults.tristate.posBarColor = e,
        $.fn.sparkline.defaults.tristate.negBarColor = f,
        $.fn.sparkline.defaults.discrete.thresholdColor = f,
        $.fn.sparkline.defaults.bullet.targetColor = e,
        $.fn.sparkline.defaults.bullet.performanceColor = f,
        $.fn.sparkline.defaults.bullet.rangeColors[0] = b.setAlpha(.2).toString(),
        $.fn.sparkline.defaults.bullet.rangeColors[1] = b.setAlpha(.5).toString(),
        $.fn.sparkline.defaults.bullet.rangeColors[2] = b.setAlpha(.45).toString(),
        $.fn.sparkline.defaults.pie.sliceColors[0] = e,
        $.fn.sparkline.defaults.pie.sliceColors[1] = f,
        $.fn.sparkline.defaults.pie.sliceColors[2] = g,
        $.fn.sparkline.defaults.box.medianColor = e,
        $.fn.sparkline.defaults.box.boxFillColor = b.setAlpha(.5).toString(),
        $.fn.sparkline.defaults.box.boxLineColor = e,
        $.fn.sparkline.defaults.box.whiskerColor = h,
...
App = function() {
    ...
    return App.charts = function() {
        ...
        function g() {
            ...
            b = App.color.alt1,
            c = [[1, 20], [2, 60], [3, 35], [4, 70], [5, 45]],
            d = [[1, 60], [2, 20], [3, 65], [4, 35], [5, 65]];
        ...
        function i() {
            ...
            c = App.color.primary,
            d = [[1, a()], [2, a()], [3, 2 + a()], [4, 3 + a()], [5, 5 + a()], [6, 10 + a()], [7, 15 + a()], [8, 20 + a()], [9, 25 + a()], [10, 30 + a()], [11, 35 + a()], [12, 25 + a()], [13, 15 + a()], [14, 20 + a()], [15, 45 + a()], [16, 50 + a()], [17, 65 + a()], [18, 70 + a()], [19, 85 + a()], [20, 80 + a()], [21, 75 + a()], [22, 80 + a()], [23, 75 + a()]],
            e = [[1, a()], [2, a()], [3, 10 + a()], [4, 15 + a()], [5, 20 + a()], [6, 25 + a()], [7, 30 + a()], [8, 35 + a()], [9, 40 + a()], [10, 45 + a()], [11, 50 + a()], [12, 55 + a()], [13, 60 + a()], [14, 70 + a()], [15, 75 + a()], [16, 80 + a()], [17, 85 + a()], [18, 90 + a()], [19, 95 + a()], [20, 100 + a()], [21, 110 + a()], [22, 120 + a()], [23, 130 + a()]];
        ...
        function j() {
            ...
            d = [[1, 10], [2, 30], [3, 55], [4, 36], [5, 57], [6, 80], [7, 65], [8, 50], [9, 80], [10, 70], [11, 90], [12, 67], [12, 67]],
            e = ($.plot("#line-chart2", [{
                data: d,
                showLabels: !0,
                label: "New Visitors",
...
//            })
        ...
        function f() {
            var a = ($("#line-chart1"), [[1, 10], [2, 30], [3, 55], [4, 36], [5, 57], [6, 80], [7, 65], [8, 50], [9, 80], [10, 70], [11, 90], [12, 67], [12, 67]]),
            b = App.color.alt3;
            $.plot("#line-chart1", [{
                data: a,
                showLabels: !0,
        ...
        function h() {
            var a = [[1, 20], [2, 60], [3, 35], [4, 70], [5, 45]],
            b = [[1, 60], [2, 20], [3, 65], [4, 35], [5, 65]],
            c = App.color.alt2;
            $.plot("#linechart-mini1", [{
                data: a,
                canvasRender: !0
...
App = function() {
    ...
    return App.dashboard2 = function() {
        ...
        function c() {
            var b = [[1, a()], [2, a()], [3, 2 + a()], [4, 3 + a()], [5, 5 + a()], [6, 10 + a()], [7, 15 + a()], [8, 20 + a()], [9, 25 + a()], [10, 30 + a()], [11, 35 + a()], [12, 25 + a()], [13, 15 + a()], [14, 20 + a()], [15, 45 + a()], [16, 50 + a()], [17, 65 + a()], [18, 70 + a()], [19, 85 + a()], [20, 80 + a()], [21, 75 + a()], [22, 80 + a()], [23, 75 + a()]],
            c = [[1, a()], [2, a()], [3, 10 + a()], [4, 15 + a()], [5, 20 + a()], [6, 25 + a()], [7, 30 + a()], [8, 35 + a()], [9, 40 + a()], [10, 45 + a()], [11, 50 + a()], [12, 55 + a()], [13, 60 + a()], [14, 70 + a()], [15, 75 + a()], [16, 80 + a()], [17, 85 + a()], [18, 90 + a()], [19, 95 + a()], [20, 100 + a()], [21, 110 + a()], [22, 120 + a()], [23, 130 + a()]],
        ...
        function h() {
            ...
            b.add($(".icon1", a)[0], Skycons.CLEAR_DAY),
            b.add($(".icon2", a)[0], Skycons.PARTLY_CLOUDY_DAY),
            b.add($(".icon3", a)[0], Skycons.RAIN),
            b.play()
        }
        b(),
        c(),
