...
function(a) {
    ...
    C = function() {
        ...
        (a = /(?=.+Mac OS X)(?=.+Firefox)/.test(c)) ? (d = /Firefox\/\d{2}\./.exec(c), d && (d = d[0].replace(/\D+/g, "")), a && +d > 23) : !1
    },
    q = function() {
        function j(d, f) {
            this.el = d,
        ...
        j.prototype.generate = function() {
            ...
            0 === e && C() ? (d = b.getComputedStyle(this.content, null).getPropertyValue("padding-right").replace(/[^0-9.]+/g, ""), c = {
                right: -14,
                paddingRight: 14
            }) : e && (c = {
                right: -e
    ...
    a.fn.nanoScroller = function(b) {
        return this.each(function() {
            ...
            z, b), this.nanoscroller = d = new q(this, c)), b && "object" == typeof b) {
